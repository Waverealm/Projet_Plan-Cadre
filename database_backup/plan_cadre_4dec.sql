...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 02 Décembre 2015 à 20:52
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `DELETE_OLD_VERSION_PLANCADRE`(IN `PCODECOURS` CHAR(10), IN `PETAT` VARCHAR(30))
    NO SQL
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SELECT_ALL_PLAN_CADRE`()
    NO SQL
BEGIN
  SELECT No_PlanCadre, CodeCours, NomCours, CodeProgramme, NomProgramme, Etat, plancadre.DateAjout, DateAdoption, Presentation_Cours, Objectifs_Integration, Evaluation_Apprentissage Enonce_Competences, Objectifs_Apprentissage, Manuel_Obligatoire, Recommandation FROM plancadre
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SELECT_OFFICIAL_PLAN_CADRE_CLASS`(IN `PCODECOURS` CHAR(10), IN `POFFICIEL` BOOLEAN)
    NO SQL
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SELECT_PLAN_CADRE_OFFICIEL_PROGRAM`(IN `PETAT` VARCHAR(30), IN `PCODEPROGRAMME` CHAR(6))
    NO SQL
BEGIN
  SELECT No_PlanCadre, CodeCours, NomCours, CodeProgramme, NomProgramme, Etat, plancadre.DateAjout, DateAdoption, Presentation_Cours, Objectifs_Integration, Evaluation_Apprentissage Enonce_Competences, Objectifs_Apprentissage, Manuel_Obligatoire, Recommandation FROM plancadre
  INNER JOIN cours ON Cours_CodeCours = CodeCours
  INNER JOIN programme on Programme_CodeProgramme = CodeProgramme
  WHERE Etat = PETAT && Programme_CodeProgramme = PCODEPROGRAMME
  ORDER BY CodeCours;
END$$
...
(4, '340-101-MQ', 'Élaboration', 0, NULL, '2015-11-18', '../plancadre/../plancadre/4_340-101-MQ_presentation.txt', '../plancadre/../plancadre/4_340-101-MQ_integration.txt', '../plancadre/../plancadre/4_340-101-MQ_evaluation.txt', '../plancadre/../plancadre/4_340-101-MQ_competences.txt', '../plancadre/../plancadre/4_340-101-MQ_apprentissage.txt', NULL, NULL),
(90, '393-DE0-LG', 'Élaboration', 0, NULL, '2015-12-02', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(98, '420-EDA-05', '1', 0, NULL, '2015-12-02', '../plancadre/../plancadre/3_420-EDA-05_presentation.txt', '../plancadre/../plancadre/3_420-EDA-05_integration.txt', '../plancadre/../plancadre/3_420-EDA-05_evaluation.txt', '../plancadre/../plancadre/3_420-EDA-05_competences.txt', '../plancadre/../plancadre/3_420-EDA-05_apprentissage.txt', NULL, NULL),
(99, '420-EDA-05', 'Élaboration', 0, NULL, '2015-12-02', '../plancadre/../plancadre/3_420-EDA-05_presentation.txt', '../plancadre/../plancadre/3_420-EDA-05_integration.txt', '../plancadre/../plancadre/3_420-EDA-05_evaluation.txt', '../plancadre/../plancadre/3_420-EDA-05_competences.txt', '../plancadre/../plancadre/3_420-EDA-05_apprentissage.txt', NULL, NULL),
(100, '420-EDA-05', 'Validé', 0, NULL, '2015-12-02', '../plancadre/../plancadre/3_420-EDA-05_presentation.txt', '../plancadre/../plancadre/3_420-EDA-05_integration.txt', '../plancadre/../plancadre/3_420-EDA-05_evaluation.txt', '../plancadre/../plancadre/3_420-EDA-05_competences.txt', '../plancadre/../plancadre/3_420-EDA-05_apprentissage.txt', NULL, NULL),
(101, '420-EDA-05', 'elaboratio', 0, NULL, '2015-12-02', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(102, '420-EDA-05', 'Élaboratio', 0, NULL, '2015-12-02', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
