...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 08 Février 2016 à 22:48
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SELECT_SECTIONS_PLANCADRES_ID`(IN `Pplan_id` INT)
    NO SQL
BEGIN
SELECT id, plancadre_id, emplacement, titre FROM plancadres_sections where plancadre_id = Pplan_id;
END$$
...
INSERT INTO `plancadre` (`No_PlanCadre`, `Cours_CodeCours`, `Etat`, `Officiel`, `DateAdoption`, `DateAjout`, `datemodification`) VALUES
(177, '420-EDA-05', 'Élaboration', 0, NULL, '2015-12-11', '2016-02-08 15:55:36'),
(178, '393-DE0-LG', 'Élaboration', 0, NULL, '2015-12-11', '2016-02-08 15:55:36'),
(192, '340-101-MQ', 'Adopté', 1, '2015-12-15', '2015-12-11', '2016-02-08 15:55:36'),
(208, '340-101-MQ', 'Élaboration', 0, NULL, '2015-12-15', '2016-02-08 15:55:36'),
(209, '340-101-MQ', 'Validé', 0, NULL, '2015-12-15', '2016-02-08 15:55:36'),
(211, '202-NYB-05', 'Élaboration', 0, NULL, '2016-01-18', '2016-02-08 15:55:36'),
(212, '202-NYA-05', 'Élaboration', 0, NULL, '2016-01-19', '2016-02-08 15:55:36');
