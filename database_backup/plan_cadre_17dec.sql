...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 17 Décembre 2015 à 16:19
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SELECT_ALL_INFO_PLAN_CADRE_ID`(IN `PNoPlanCadre` INT)
    NO SQL
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SELECT_ALL_OFFICIEL_PLAN_CADRE`()
    NO SQL
BEGIN
  SELECT No_PlanCadre, CodeCours, Officiel, NomCours, CodeProgramme, NomProgramme, Etat, plancadre.DateAjout, DateAdoption, Presentation_Cours, Objectifs_Integration, Evaluation_Apprentissage Enonce_Competences, Objectifs_Apprentissage, Manuel_Obligatoire, Recommandation FROM plancadre
...
(11, '410-CA1-LG', 'Initiation au marketing', 'Enseignement régulier', '2-1-1', '2.000000', 60, '410.D0', '2015-12-16'),
(12, '401-CA0-LG', 'Introduction au droit des affaires', 'Enseignement régulier', '2-1-2', '2.000000', 80, '410.D0', '2015-12-16'),
(13, '201-CA0-LG', 'Mathématique appliquées à la gestion', 'Enseignement régulier', '2-1-2', '1.000000', 60, '410.D0', '2015-12-16'),
(14, '410-CA4-LG', 'Comptabilité intermédiaire A', 'Enseignement régulier', '2-2-3', '0.000000', 70, '410.D0', '2015-12-16'),
(15, '410-CJ4-LG', 'Aménagement d''un commerce de détail', 'Enseignement régulier', '1-3-3', '1.000000', 50, '410.D0', '2015-12-16'),
(16, '401-CJ1-LG', 'Supervision du personnel de vente', 'Enseignement régulier', '2-1-2', '2.000000', 80, '410.D0', '2015-12-16'),
(17, '203-NYA -0', 'Mécanique', 'Enseignement régulier', '3-2-3', '1.000000', 60, '200.B0', '2015-12-16'),
(18, '201-NYB-05', 'Calcul intégral', 'Enseignement régulier', '3-2-3', '2.000000', 60, '200.B0', '2015-12-16'),
(19, '201-NYC -0', 'Algèbre linéaire et géométrie vectorielle', 'Enseignement régulier', '3-2-3', '3.000000', 60, '200.B0', '2015-12-16'),
(20, '201-NYA-05', 'Calcul différentiel', 'Enseignement régulier', '3-2-3', '1.000000', 70, '200.B0', '2015-12-16');
...
(192, '340-101-MQ', 'Adopté', 1, '2015-12-15', '2015-12-11', '../plancadre/../plancadre/4_340-101-MQ_presentation.txt', '../plancadre/../plancadre/4_340-101-MQ_integration.txt', '../plancadre/../plancadre/4_340-101-MQ_evaluation.txt', '../plancadre/../plancadre/4_340-101-MQ_competences.txt', '../plancadre/../plancadre/4_340-101-MQ_apprentissage.txt', NULL, NULL),
(208, '340-101-MQ', 'Élaboration', 0, NULL, '2015-12-15', '../plancadre/../plancadre/4_340-101-MQ_presentation.txt', '../plancadre/../plancadre/4_340-101-MQ_integration.txt', '../plancadre/../plancadre/4_340-101-MQ_evaluation.txt', '../plancadre/../plancadre/4_340-101-MQ_competences.txt', '../plancadre/../plancadre/4_340-101-MQ_apprentissage.txt', NULL, NULL),
(209, '340-101-MQ', 'Validé', 0, NULL, '2015-12-15', '../plancadre/../plancadre/4_340-101-MQ_presentation.txt', '../plancadre/../plancadre/4_340-101-MQ_integration.txt', '../plancadre/../plancadre/4_340-101-MQ_evaluation.txt', '../plancadre/../plancadre/4_340-101-MQ_competences.txt', '../plancadre/../plancadre/4_340-101-MQ_apprentissage.txt', NULL, NULL),
(210, '203-NYA -0', 'Élaboration', 0, NULL, '2015-12-16', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(211, '202-NYB-05', 'Élaboration', 0, NULL, '2015-12-16', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
('410.D0', 'Gestion de commerces', 'Technique', 'Diplôme d''études collégiales', '2015-12-16');
...
(17, 'Moited', 'sha256:1000:/A39cmCrbNOmXJ8WKrXW4e1TnPuGFj0F:472qbXASb+ixj+lkq7h9bW5tBp4cnA3R', '123@tdy.ca', 'pas un nom', 'noum', 'Élaborateur', 'Actif');
