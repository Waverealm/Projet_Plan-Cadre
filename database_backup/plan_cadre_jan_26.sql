...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 26 Janvier 2016 à 22:46
...
--
-- Structure de la table `plancadreconsignes`
--

CREATE TABLE IF NOT EXISTS `plancadreconsignes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Structure de la table `plancadreofficiel`
--

CREATE TABLE IF NOT EXISTS `plancadreofficiel` (
  `plancadre_id` int(11) NOT NULL,
  `cours_code` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`plancadre_id`),
  UNIQUE KEY `plancadreofficiel_fk_code` (`cours_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `plancadres` (
  ...
  `dateadoption` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Contraintes pour la table `plancadreofficiel`
--
ALTER TABLE `plancadreofficiel`
  ADD CONSTRAINT `plancadreofficiel_ibfk_1` FOREIGN KEY (`cours_code`) REFERENCES `cours` (`code`) ON UPDATE CASCADE;
