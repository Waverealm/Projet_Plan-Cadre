...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 21 Janvier 2016 à 21:36
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SELECT_PLAN_CADRE_ID`(IN `PNoPlanCadre` INT(11))
    NO SQL
BEGIN
SELECT CodeCours, NomCours, TypeCours, Ponderation, NombreUnites, NombreHeures, CodeProgramme, NomProgramme, No_PlanCadre, plancadre.DateAjout FROM plancadre INNER JOIN cours ON Cours_CodeCours = CodeCours
INNER JOIN programme ON CodeProgramme = Programme_CodeProgramme
WHERE No_PlanCadre = PNoPlanCadre;
END$$
...
INSERT INTO `plancadre` (`No_PlanCadre`, `Cours_CodeCours`, `Etat`, `Officiel`, `DateAdoption`, `DateAjout`) VALUES
(177, '420-EDA-05', 'Élaboration', 0, NULL, '2015-12-11'),
(178, '393-DE0-LG', 'Élaboration', 0, NULL, '2015-12-11'),
(192, '340-101-MQ', 'Adopté', 1, '2015-12-15', '2015-12-11'),
(208, '340-101-MQ', 'Élaboration', 0, NULL, '2015-12-15'),
(209, '340-101-MQ', 'Validé', 0, NULL, '2015-12-15'),
(211, '202-NYB-05', 'Élaboration', 0, NULL, '2016-01-18'),
(212, '202-NYA-05', 'Élaboration', 0, NULL, '2016-01-19');
