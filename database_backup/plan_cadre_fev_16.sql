...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 16 Février 2016 à 23:15
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `PLANCADRES_SELECT_DATEMODIFICATION`(IN `pid` INT)
    NO SQL
BEGIN
SELECT datemodification, updating FROM plancadre
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `PLANCADRES_UPDATE_UPDATING`(IN `pid` INT, IN `pupdating` INT)
    NO SQL
BEGIN
UPDATE plancadre SET updating = pupdating WHERE No_plancadre = pid;
END$$
...
(177, '420-EDA-05', 'Élaboration', 0, NULL, '2015-12-11', '0000-00-00 00:00:00', 0),
(178, '393-DE0-LG', 'Élaboration', 0, NULL, '2015-12-11', '2016-02-08 15:55:36', 1),
...
(211, '202-NYB-05', 'Élaboration', 0, NULL, '2016-01-18', '2016-02-08 15:55:36', 0),
(212, '202-NYA-05', 'Élaboration', 0, NULL, '2016-01-19', '2016-02-08 15:55:36', 0),
(213, '152-ER5-LG', 'Élaboration', 0, NULL, '2016-02-09', '2016-02-09 09:42:24', 0),
(214, '152-R04-LG', 'Élaboration', 0, NULL, '2016-02-09', '2016-02-09 10:40:16', 0),
(215, 'test', 'Élaboration', 0, NULL, '2016-02-09', '2016-02-09 11:28:42', 0),
