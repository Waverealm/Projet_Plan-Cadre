...
class SQLQuery {
	...
	function search() {
		...
		/*
			1 = 1 permet d'éviter à avoir à placer le where de la requête
			Ça améliore le code pour des requêtes avec un nombre variable de conditions
			en évitant d'avoir à déterminer si le where est présent ou non.
		*/
		$conditions = '\'1\'=\'1\' AND ';
		$conditionsChild = '';
		$fromChild = '';
